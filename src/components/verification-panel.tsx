      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
              ...
              currently returns a public
              posting. Greenhouse and Lever
              listings receive posting-ID
              verification. Other sites
        ...
        {!listingUrl.trim() && (
          <p className="mt-5 rounded-xl bg-slate-100 p-4 text-sm text-slate-700">
            Add a public listing URL in the
            form above to use this check.
          </p>
        )}
